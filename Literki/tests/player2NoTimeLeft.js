...
describe('Player2 no time left Suite', function () {
    ...
    it('/game/move Player1', function (done) {
        var data = {
    ...
    it('/game/approve Player2', function (done) {
        var data = {
            gameId: initState.gameId,
            approve: true
        };
    ...
    it('/player/alive Player1 after Player1 move', function (done) {
...
//# sourceMappingURL=player2NoTimeLeft.js.map